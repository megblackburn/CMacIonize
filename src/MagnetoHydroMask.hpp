 ...
 */
#ifndef MAGNETOHYDROMASK_HPP
#define MAGNETOHYDROMASK_HPP
 ...
 * constant value.
 */
class MagnetoHydroMask {
public:
  /**
   * @brief Virtual destructor.
   */
  virtual ~MagnetoHydroMask() {}

  /**
   * @brief Initialize the mask before the first magneto-hydrodynamical time step.
   *
