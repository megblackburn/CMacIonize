...
void DensityGrid::set_densities(std::pair< cellsize_t, cellsize_t > &block,
  ...
  WorkDistributor<
      DensityGridTraversalJobMarket< DensityGridInitializationFunction, DensityGrid >,
      DensityGridTraversalJob< DensityGridInitializationFunction, DensityGrid > >
      workers(worksize);
  ...
  DensityGridTraversalJobMarket< DensityGridInitializationFunction, DensityGrid > jobs(
      *this, init, block);
