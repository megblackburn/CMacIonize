...
private:
  ...
  double _draine_freq[250];
  double _draine_kappa[250];
//  double _draine_kappa_si[250];
 // double _draine_kappa_gr[250];
  uint_fast32_t _num_dust_vals = 250;
...
public:
  ...
  double get_dust_opacity(const double energy) const;
