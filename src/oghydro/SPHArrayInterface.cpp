...
void SPHArrayInterface::write(DensityGrid &grid, uint_fast32_t iteration,
  ...
  WorkDistributor< DensityGridTraversalJobMarket< InverseMappingFunction, DensityGrid >,
                   DensityGridTraversalJob< InverseMappingFunction, DensityGrid > >
      workers;

  InverseMappingFunction do_calculation(*this, locks);

  DensityGridTraversalJobMarket< InverseMappingFunction, DensityGrid > jobs(
