...
/**
 * @file MilkyWaySFR.cpp
 *
 * @brief MilkyWaySFR implementation.
 *
 ...
 */
MilkyWaySFR::MilkyWaySFR(std::string filename, Log *log) {
...
double MilkyWaySFR::get_sfr_at_time(double target_time) const {
 ...
 * @param log Log to write logging info to.
 */
MilkyWaySFR::MilkyWaySFR(std::string role, ParameterFile &params, Log *log)
    : MilkyWaySFR(
 ...
 */
std::string MilkyWaySFR::get_filename(std::string input_filename) {
  std::stringstream ss;
...
double MilkyWaySFR::interpolate_value(double target_time, const std::vector< double > &time_axis, const std::vector< double > &data_axis) const {
...
double MilkyWaySFR::get_random_frequency(RandomGenerator &random_generator, double temperature) const {
    return 0.0; 
}

double MilkyWaySFR::get_total_flux() const {
    return 0.0; 
}