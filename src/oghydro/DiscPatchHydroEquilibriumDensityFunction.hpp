 ...
 */
#ifndef DISCPATCHHYDROEQUILIBRIUMDENSITYFUNCTION_HPP
#define DISCPATCHHYDROEQUILIBRIUMDENSITYFUNCTION_HPP
 ...
 */
class DiscPatchHydroEquilibriumDensityFunction : public DensityFunction {
private:
...
public:
   ...
   * @f$x_{\rm{}H}@f$.
   */
  inline DiscPatchHydroEquilibriumDensityFunction(const double disc_z,
      ...
      : _disc_z(disc_z), _b_inv(1. / scale_height),
        ...
        _density_norm(0.5 * gas_fraction * surface_density *
                      ...
                      PhysicalConstants::get_physical_constant(
                          PHYSICALCONSTANT_PROTON_MASS)),
        _temperature(temperature), _neutral_fraction(neutral_fraction), _trace_initial_neutral_flag(trace_initial_neutral_flag), _temperature_to_trace(temperature_to_trace) {}
   ...
   */
  inline DiscPatchHydroEquilibriumDensityFunction(ParameterFile &params)
      : DiscPatchHydroEquilibriumDensityFunction(
   ...
   */
  virtual ~DiscPatchHydroEquilibriumDensityFunction() {} /// Lewis's edited density function: mgb note 30.10.2025
