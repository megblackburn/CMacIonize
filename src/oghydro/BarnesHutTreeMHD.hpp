...
class BarnesHutTreeMHD {
public:
  BarnesHutTreeMHD(const CoordinateVector<double> &grid_dimensions,const CoordinateVector<double> box_anchor, double theta)
  ...
  void insert(const MagnetoHydroDensitySubGrid::hydroiterator &cell) {
  ...
  CoordinateVector<double> compute_gravity(MagnetoHydroDensitySubGrid::hydroiterator& cell) const {
  ...
  public:
    ...
    CoordinateVector<double> compute_gravity_recursive(MagnetoHydroDensitySubGrid::hydroiterator& cell, double theta) {
