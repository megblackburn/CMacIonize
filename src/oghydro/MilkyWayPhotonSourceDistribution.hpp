...
// Stellar Sources
    if (_total_time - _last_sf > _update_interval) {
      ...
      mwsfr = new MilkyWaySFR(_sfr_filename);
      double _star_formation_rate = mwsfr->get_sfr_at_time(_total_time);
      ...
      if (_output_file2 != nullptr) {
       ...
       std::cout << " _update_interval: " << _update_interval << ", SFR: " << _star_formation_rate << ", mass_to_generate: " << mass_to_generate << std::endl;
