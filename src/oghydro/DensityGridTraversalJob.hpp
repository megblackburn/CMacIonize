 ...
 * @brief Job that should be performed on every cell of the DensityGrid.
 */
template < typename _function_, typename GridType> class DensityGridTraversalJob {
private:
  /*! @brief Iterator to the first cell that should be visited. */
  typename GridType::iterator _begin;

  /*! @brief Iterator to the cell beyond the last cell that should be visited.
   */
  typename GridType::iterator _end;
...
public:
   ...
   * DensityGrid::iterator as single parameter.
   */
  DensityGridTraversalJob(typename GridType::iterator begin,
                          typename GridType::iterator end, _function_ &function)
