 ...
 */
#ifndef BONDIPROFILEMHD_HPP
#define BONDIPROFILEMHD_HPP
...
public:
   ...
   * profile (in m s^-1).
   */
  inline BondiProfileMHD(const double central_mass, const double bondi_density,
   ...
   */
  inline BondiProfileMHD(ParameterFile &params)
      : BondiProfileMHD(
  ...
  inline void get_magnetohydrodynamic_variables(const CoordinateVector<> position, // mgb edit 21.04.2026 added in
                                         double &density,
