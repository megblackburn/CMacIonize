...
public:
   ...
   */
  inline void set_neutral_scalar_field(double neutral_gas_field) { // mgb edit 26.05.2026 - add in a field to track the initialised cold gas cells
    _neutral_gas_field = neutral_gas_field;
  }
   ...
   * @param neutral_gas_field 
   */
  inline double get_neutral_scalar_field() const { // mgb edit 26.05.2026 - add in a field to track the initialised cold gas cells
    return _neutral_gas_field;
  }
