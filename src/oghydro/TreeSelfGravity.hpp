...
public:
  ...
  inline void compute_accelerations(DensityGrid &grid) {
    ...
    WorkDistributor< DensityGridTraversalJobMarket< GravityComputation, DensityGrid >,
                     DensityGridTraversalJob< GravityComputation, DensityGrid > >
        workers;
    DensityGridTraversalJobMarket< GravityComputation, DensityGrid > jobs(grid, gravity,
                                                             block);
