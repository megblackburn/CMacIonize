 ...
 */
#ifndef AREPOSNAPSHOTPHOTONSOURCEDISTRIBUTION_HPP
#define AREPOSNAPSHOTPHOTONSOURCEDISTRIBUTION_HPP
 ...
 * 3 snapshot file.
 */
class ArepoSnapshotPhotonSourceDistribution : public PhotonSourceDistribution {
private:
...
public:
  ArepoSnapshotPhotonSourceDistribution(
      ...
      Log *log = nullptr);
  ArepoSnapshotPhotonSourceDistribution(ParameterFile &params,
                                         Log *log = nullptr);
...
#endif // AREPOSNAPSHOTPHOTONSOURCEDISTRIBUTION_HPP
