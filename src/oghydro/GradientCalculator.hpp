...
public:
  ...
  compute_gradient(DensityGrid::iterator &cell,
    ...
    const double WL[7] = {cell.get_hydro_variables().primitives(0),
    ...
    double phi_ngb_max[7] = {-DBL_MAX, -DBL_MAX, -DBL_MAX, -DBL_MAX, -DBL_MAX, -DBL_MAX, -DBL_MAX};
    double phi_ngb_min[7] = {DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX};
    for (auto ngbit = ngbs.begin(); ngbit != ngbs.end(); ++ngbit) {
      ...
      if (ngb != grid_end) {
        ...
        WR[4] = ngb.get_hydro_variables().primitives(5);
        WR[4] = ngb.get_hydro_variables().primitives(6);
      } else {
    ...
    double phi_ext_max[7] = {-DBL_MAX, -DBL_MAX, -DBL_MAX, -DBL_MAX, -DBL_MAX, -DBL_MAX, -DBL_MAX};
    double phi_ext_min[7] = {DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX, DBL_MAX};
