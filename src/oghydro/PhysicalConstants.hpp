...
enum PhysicalConstantName {
  ...
  /*! @brief Magnetic Permeability of Free Space (in H m^-1). */
  PHYSICALCONSTANT_MAGNETC_PERMEABILITY, // mgb edit 21.04.2026
...
public:
  ...
  static inline double get_physical_constant(PhysicalConstantName name) {
    ...
    case PHYSICALCONSTANT_ASTRONOMICAL_UNIT:
      ...
      // in m
      return 149597870700.;
    case PHYSICALCONSTANT_MAGNETC_PERMEABILITY: // mgb edit 21.04.2026
      // in H m^-1
