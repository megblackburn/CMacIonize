 ...
 */
#ifndef CMACIONIZESNAPSHOTDENSITYFUNCTIONMHD_HPP
#define CMACIONIZESNAPSHOTDENSITYFUNCTIONMHD_HPP
 ...
 * @brief DensityFunction that reads a density grid from a CMacIonize snapshot.
 */
class CMacIonizeSnapshotDensityFunctionMHD : public DensityFunctionMHD {
private:
...
public:
  CMacIonizeSnapshotDensityFunctionMHD(std::string filename,
  ...
  CMacIonizeSnapshotDensityFunctionMHD(ParameterFile &params, Log *log = nullptr);

  virtual ~CMacIonizeSnapshotDensityFunctionMHD();
