 ...
 */
#ifndef READMILKYWAYSFR_HPP
#define READMILKYWAYSFR_HPP
 ...
 */
class ReadMilkyWaySFR : public PhotonSourceSpectrum {
private:
...
public:
  ReadMilkyWaySFR(std::string input_filename, Log *log = nullptr);

  ReadMilkyWaySFR(std::string role, ParameterFile &params,
                              Log *log = nullptr);
