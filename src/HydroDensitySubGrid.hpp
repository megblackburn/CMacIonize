...
public:
  ...
  virtual void initialize_hydro(const uint_fast32_t index,
    ...
    _hydro_variables[index].set_primitives_remaining_initial_cold_field(values.get_initial_neutral_scalar_field());
    _hydro_variables[index].set_primitives_remaining_cooled_cold_field(values.get_cooled_neutral_scalar_field());
    _hydro_variables[index].set_primitives_currently_cooled_cold_field(0.0);
