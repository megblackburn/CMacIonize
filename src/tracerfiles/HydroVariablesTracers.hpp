...
/**
 * @file HydroVariablesTracers.hpp
 *
 * @brief Hydro related variables.
 *
 * @author Bert Vandenbroucke (bv7@st-andrews.ac.uk)
 */
#ifndef HYDROVARIABLESTRACERS_HPP
#define HYDROVARIABLESTRACERS_HPP
...
public:
   ...
   */
  inline HydroVariablesTracers()
      : _primitives{0., 0., 0., 0., 0., 0., 0.}, _conserved{0., 0., 0., 0., 0., 0., 0.},
        _delta_conserved{0., 0., 0., 0., 0., 0., 0.}, _energy_rate_term(0.),
   ...
   * @return Fluid pressure (in kg m^-1 s^-2).
   */
  inline double get_primitives_cooled_gas_scalar_field() const { return _primitives[5]; }
   ...
   * @return Fluid pressure (in kg m^-1 s^-2).
   */
  inline double get_primitives_initial_cold_gas_scalar_field() const { return _primitives[6]; }
   ...
   * @param pressure New fluid pressure (in kg m^-1 s^-2).
   */
  inline void set_primitives_cooled_gas_scalar_field(const double scalar) {
    _primitives[5] = scalar;
  }
   ...
   * @param pressure New fluid pressure (in kg m^-1 s^-2).
   */
  inline void set_primitives_initial_cold_gas_scalar_field(const double scalar) {
    _primitives[6] = scalar;
  }
   ...
   * @return Fluid total energy (in kg m^2 s^-2).
   */
  inline double get_conserved_cooled_gas_scalar_field() const { return _conserved[5]; }
   ...
   * @return Fluid total energy (in kg m^2 s^-2).
   */
  inline double get_conserved_initial_cold_gas_scalar_field() const { return _conserved[6]; }
   ...
   * @param total_energy New fluid total energy (in kg m^2 s^-2).
   */
  inline void set_conserved_cooled_gas_scalar_field(const double scalar) {
    _conserved[5] = scalar;
  }
   ...
   * @param total_energy New fluid total energy (in kg m^2 s^-2).
   */
  inline void set_conserved_initial_cold_gas_scalar_field(const double scalar) {
    _conserved[6] = scalar;
  }
  ...
  /**
   * @brief Copy the contents of the given HydroVariablesTracers instance into
   * this one.
   *
   * @param other Other HydroVariablesTracers instance.
   */
  inline void copy_all(const HydroVariablesTracers &other) {
   ...
   */
  inline HydroVariablesTracers(RestartReader &restart_reader) {
...
#endif // HYDROVARIABLESTRACERS_HPP
