...
public:
   ...
   */
  inline HLLDRiemannSolver(const double gamma, const double mu0) // mgb edit 21.04.2026 - add mu0 and cleaning speed parameters for MHD
