...
public:
   ...
   */
  inline static DensityGridMHD *generate(const SimulationBox &simulation_box,
   ...
   * management for the pointer needs to be done by the calling routine.
   */
  inline static DensityGridMHD *restart(RestartReader &restart_reader,
                                     Log *log = nullptr) {
...
#endif // DENSITYGRIDFACTORYMHD_HPP
