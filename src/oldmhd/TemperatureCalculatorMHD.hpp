 ...
 */
#ifndef TEMPERATURECALCULATORMHD_HPP
#define TEMPERATURECALCULATORMHD_HPP
 ...
 */
class TemperatureCalculatorMHD {
private:
...
public:
  ...
  TemperatureCalculatorMHD(double luminosity, const Abundances &abundances,
                        const LineCoolingData &line_cooling_data,
                        const RecombinationRates &recombination_rates,
                        const ChargeTransferRates &charge_transfer_rates,
                        const CollisionalRates &collisional_rates,
  ...
  private:
    ...
    const TemperatureCalculatorMHD &_calculator;
  ...
  public:
     ...
     * call.
     */
    TemperatureCalculatorFunction(const TemperatureCalculatorMHD &calculator,
...
#endif // TEMPERATURECALCULATORMHD_HPP