...
/**
 * @file TemperatureCalculatorMHD.cpp
 *
 * @brief TemperatureCalculatorMHD implementation.
 *
 * @author Bert Vandenbroucke (bv7@st-andrews.ac.uk)
 */
#include "TemperatureCalculatorMHD.hpp"
#include "Abundances.hpp"
#include "ChargeTransferRates.hpp"
#include "CollisionalRates.hpp"
#include "Configuration.hpp"
#include "DensityGridMHD.hpp"
#include "DensityGridTraversalJobMarketMHD.hpp"
 ...
 */
TemperatureCalculatorMHD::TemperatureCalculatorMHD(
 ...
 * fractions.
 */
void TemperatureCalculatorMHD::compute_cooling_and_heating_balance(
 ...
 */
void TemperatureCalculatorMHD::calculate_temperature(
...
void TemperatureCalculatorMHD::calculate_temperature(
  ...
  if (_do_temperature_computation && loop > _minimum_iteration_number) {
    ...
    WorkDistributor<
        DensityGridTraversalJobMarketMHD< TemperatureCalculatorFunction >,
        DensityGridTraversalJoMHD< TemperatureCalculatorFunction > >
        workers;
    TemperatureCalculatorFunction do_calculation(*this, jfac, hfac, timestep);
    DensityGridTraversalJobMarketMHD< TemperatureCalculatorFunction > jobs(
