...
/**
 * @file InternalMagnetoHydroUnits.hpp
 *
 * @brief Internal unit system for magneto-hydrodynamics.
 *
 * @author Bert Vandenbroucke (bv7@st-andrews.ac.uk)
 */
#ifndef INTERNALMAGNETOHYDROUNITS_HPP
#define INTERNALMAGNETOHYDROUNITS_HPP
...
public:
   ...
   * (in kg m^-1 s^-2).
   */
  InternalMagnetoHydroUnits(const double average_box_size,
...
#endif // INTERNALMAGNETOHYDROUNITS_HPP
