 ...
 */
void DensityGridMHD::set_densities(std::pair< cellsize_t, cellsize_t > &block,
                                DensityFunctionMHD &function,
                                int_fast32_t worksize) {

  DensityGridInitializationFunction init(function, _has_hydro);
  WorkDistributor<
      DensityGridTraversalJobMarket< DensityGridInitializationFunction, DensityGridMHD >,
      DensityGridTraversalJob< DensityGridInitializationFunction,DensityGridMHD > >
      workers(worksize);
  ...
  DensityGridTraversalJobMarket< DensityGridInitializationFunction,DensityGridMHD > jobs(
      *this, init, block);
