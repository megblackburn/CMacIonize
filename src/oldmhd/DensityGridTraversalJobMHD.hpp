 ...
 */
#ifndef DENSITYGRIDTRAVERSALJOBMHD_HPP
#define DENSITYGRIDTRAVERSALJOBMHD_HPP
...
public:
   ...
   * DensityGrid::iterator as single parameter.
   */
  DensityGridTraversalJobMHD(DensityGridMHD::iterator begin,
                          DensityGridMHD::iterator end, _function_ &function)
...
#endif // DENSITYGRIDTRAVERSALJOBMHD_HPP
