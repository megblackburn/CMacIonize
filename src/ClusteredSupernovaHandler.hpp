...
/**
 * @file ClusteredSupernovaHandler.hpp
 *
 * @brief Supernova handling functions.
 *
 * @author Meg Blackburn (mgb27@st-andrews.ac.uk)
 */
#ifndef CLUSTEREDSUPERNOVAHANDLER_HPP
#define CLUSTEREDSUPERNOVAHANDLER_HPP
 ...
 */
class ClusteredSupernovaHandler {
private:
...
public:
   ...
   */
  ClusteredSupernovaHandler(const double sne_energy,
