...
/**
 * @file DiscPatchDIGDensityFunction.hpp
 *
 * @brief Disc patch DIG density function.
 *
 * @author Bert Vandenbroucke (bv7@st-andrews.ac.uk)
 */
#ifndef DISCPATCHDIGDENSITYFUNCTION_HPP
#define DISCPATCHDIGDENSITYFUNCTION_HPP
 ...
 */
class DiscPatchDIGDensityFunction : public DensityFunction {
private:
...
public:
   ...
   * @f$x_{\rm{}H}@f$.
   */
  inline DiscPatchDIGDensityFunction(const double disc_z,
   ...
   */
  inline DiscPatchDIGDensityFunction(ParameterFile &params)
      : DiscPatchDIGDensityFunction(
   ...
   */
  virtual ~DiscPatchDIGDensityFunction() {} /// Lewis's edited density function: mgb note 30.10.2025
...
#endif // DISCPATCHDIGDENSITYFUNCTION_HPP
