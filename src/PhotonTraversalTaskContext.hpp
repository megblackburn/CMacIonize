...
public:
  ...
  virtual uint_fast32_t execute(const int_fast32_t thread_id,
    ...
    PhotonTraversalThreadContext<_subgrid_type_> &traversal_thread_context =
        *static_cast< PhotonTraversalThreadContext<_subgrid_type_> * >(thread_context);
  ...
  virtual ThreadContext *get_thread_context() {
    return new PhotonTraversalThreadContext<_subgrid_type_>();
  }
};
